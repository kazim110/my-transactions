...
ActiveRecord::Schema[7.1].define(version: 2024_02_15_164842) do
  ...
  create_table "categories_purchases", id: false, force: :cascade do |t|
    ...
    t.index ["category_id", "purchase_id"], name: "index_categories_purchases_on_category_id_and_purchase_id", unique: true
